window.addEventListener('DOMContentLoaded', () => {
  ...
  // Class
  class MenyuCard {
    constructor(src, alt, title, descr, price, parentSelector, ...calsses) {
      this.src = src
      this.alt = alt
      this.title = title
      this.descr = descr
  ...
  new MenyuCard(
    ...
    'usual',
    'Plan User',
    'Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores impedit dolorum repellat similique non? A itaque, odit ex excepturi fugit aut? Ratione optio facere debitis neque corporis velit adipisci vitae.',
    10,
    '.menu .container',
    'menu__item'
  ).render()
